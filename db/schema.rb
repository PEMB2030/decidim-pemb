...
ActiveRecord::Schema.define(version: 20_210_416_102_041) do
  ...
  create_table "decidim_access_requests_access_codes", force: :cascade do |t|
    t.bigint "decidim_organization_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_organization_id"], name: "index_decidim_access_requests_access_codes_organization"
    t.index ["decidim_user_id"], name: "index_decidim_access_requests_access_codes_user"
  end
  ...
  add_foreign_key "decidim_access_requests_access_codes", "decidim_organizations"
  add_foreign_key "decidim_access_requests_access_codes", "decidim_users"
